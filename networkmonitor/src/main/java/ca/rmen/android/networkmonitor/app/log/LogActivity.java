...
public class LogActivity extends AppCompatActivity implements DialogButtonListener, ChoiceDialogFragment.DialogItemListener {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            ...
            boolean freezeHeader = NetMonPreferences.getInstance(this).getFreezeHeader();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_freeze_header:
                boolean newFreezeHeaderSetting = !NetMonPreferences.getInstance(this).getFreezeHeader();
                NetMonPreferences.getInstance(this).setFreezeHeader(newFreezeHeaderSetting);
                loadHTMLFile();
                return true;
        }
    ...
    private void loadHTMLFile() {
        ...
        final boolean freezeHeader = NetMonPreferences.getInstance(this).getFreezeHeader();
